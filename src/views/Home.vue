...
div
  //- Hero Area
  section
    v-parallax.hero.text-center(dark height="100vh"
  ...
  computed: {
    ...
    themeSpecificHeroImage() {
      if (this.isDarkTheme)
        ...
        return "https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=2089&q=80";
    }
  }
};
</script>
